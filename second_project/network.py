...
class MyTopo(Topo):
    def __init__(self):
        ...
        self.addLink("h4", "s9", **host_link_config)
        ...
        self.addLink("s3", "s6", **switch_link_config)
        self.addLink("s4", "s5", **switch_link_config)
        self.addLink("s4", "s7", **switch_link_config)
        self.addLink("s5", "s6", **switch_link_config)
        self.addLink("s6", "s9", **switch_link_config)
        self.addLink("s7", "s8", **switch_link_config)
        self.addLink("s8", "s9", **switch_link_config)
...
if __name__ == "__main__":
    ...
    subprocess.call(["./set_queue.sh", "s4", "eth2", "eth1", "s5", "eth2", "eth2", "s6"])
